function Footer() {
  return (
    <footer className="border-t border-white/10 px-6 py-8 lg:px-10" aria-label="Site footer">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 text-xs text-neutral-600 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav aria-label="Footer navigation" className="flex flex-wrap items-center gap-6 uppercase tracking-[0.14em]">
          <a href="https://github.com/matteojose3112-bit/aster" target="_blank" rel="noopener noreferrer" className="transition hover:text-white">
            GitHub ↗
          </a>
